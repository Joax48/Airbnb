...
const AccommodationForm = () => {
  const [form, setForm] = useState({
    ...
    price: "",
    location: "",
    imageUrl: "", // URL segura de Cloudinary
  });
  ...
  const uploadToCloudinary = async () => {
    ...
    return cloudinaryRes.data.secure_url; // URL segura de la imagen
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const dataToSend = { ...form, imageUrl, amenities: selectedAmenities  };
    ...
    useEffect(() => {
      axios.get("http://localhost:4000/api/amenities")
          ...
          <input
            ...
            onChange={(e) => {
              ...
              if (selectedAmenities.includes(a.id_amenity)) {
                ...
                setSelectedAmenities([...selectedAmenities, a.id_amenity]);
              }
            }}
          />
          {a.name}
